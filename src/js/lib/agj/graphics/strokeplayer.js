...
define(["agj/agj", "agj/classes/class-super", "agj/classes/destroyable", "agj/classes/geom", "agj/graphics/draw", "signals"], function (AGJ, Class, Destroyable, geom, graphics, signals) {
	"use strict";

	// Imports.
	var Point = geom.Point;
	var DrawStyle = graphics.DrawStyle;
	var draw = graphics.draw;
	...
	defineModule(brush, "StrokePlayer", Destroyable.extend({
	...
	var StrokeStyle = defineModule(brush, "StrokeStyle", Class.extend({
