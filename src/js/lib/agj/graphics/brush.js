...
define(["agj/agj", "agj/classes/class-super", "agj/classes/geom", "signals"], function (AGJ, Class, geom, signals) {
	"use strict";
	...
	var StrokeGenerator = defineModule(module, "StrokeGenerator", Class.extend({
		init: function () {
			this._strokes = [];
	...
	var Stroke = defineModule(module, "Stroke", Class.extend({
	...
	var StrokeNode = defineModule(module, "StrokeNode", Class.extend({
