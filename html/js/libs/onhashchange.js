  ...
  onAdd:function(fn) {
          ...
          if(Browser.ie6 || Browser.ie7) {
            ...
            checker = function(url,frame) {
              ...
              var isEmpty = url == '#';
              var hash, compare, cleanurl = unescape(window.location.toString());
              ...
              'id':'hashchange-ie-frame',
                ...
                'onload':function() {
                  ...
                  if(self.retrieve('loaded')) {
                    //examine the url
                    var url = unescape(ieframe.contentWindow.location.toString());
                    var index = url.indexOf('?');
                    if(index>=0) {
            ...
            checker = window.onhashchange = function(hash) {
              ...
              hash = hash && typeof hash == 'string' ? hash : window.location.hash.toString();
            ...
            checker = function(hash) {
              ...
              //compare the hash
              var hash = hash || window.location.hash.toString();
          ...
          var sethash = function(hash) {
            ...
            if(Browser.ie6 || Browser.ie7) { //ie6 and ie7
              var url = new window.location.toString();
